...
#     kf = op / op[:,0,0][:,None,None] # Calculate kf ensuring broadcasting
#     kf[:,0,0] = 0.0             # Correct syntax for slice assignment
#     kf[:,1,1] = 0.0             # Correct syntax
#     kf[:,2,2] = 0.0             # Correct syntax
#     kf[:,3,3] = 0.0             # Correct syntax
